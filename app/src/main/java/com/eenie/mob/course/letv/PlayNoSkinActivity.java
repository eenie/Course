package com.eenie.mob.course.letv;
...
import com.eenie.mob.course.PlayerFactory;
...
public class PlayNoSkinActivity extends Activity implements OnPlayStateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLocal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                player.setDataSource("http://7xovg2.media1.z0.glb.clouddn.com/%E7%BB%BF%E7%AE%AD.Arrow.S04E05.%E4%B8%AD%E8%8B%B1%E5%AD%97%E5%B9%95.HDTVrip.1024X576.mp4");
                player.prepareAsync();
    ...
    private void loadDataFromIntent() {
        ...
        if (intent != null) {
            mBundle = LetvParamsUtils.setVodParams("rmc0l67qmg", "e6968be44c", "", "823948", "", false);
            if (mBundle == null) {
